...
import App from './App';
import { fetchTransactions } from './services/transactionService/transactionService';
import { calculateRewards } from './utils/rewards/rewards';

jest.mock('./utils/fetchTransactions/fetchTransactions');
jest.mock('./utils/rewards/rewards');
